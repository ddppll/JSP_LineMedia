...
<html>
	...
	<%@ include file="/include/nav.jsp" %>
		...
		<div class="container"style="font-family: 'pretendard'; margin-top:50px; margin-bottom:50px; ">
			<form name="myform" method="post" action="${ctp}/qnaInputOk.qa">
				<table class="table">
					<tr>
					...
					<tr>
						...
						<td><input type="text" name="title" placeholder="제목을 입력하세요" class="form-control" autofocus required  style="background-color:white; border : none;"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>${fn:replace(tel,'/','-')}</td>
					</tr>
					<tr>
						<th style="text-align: center; color:white;">내용</th>
						<td style="background-color:white;"><textarea rows="6" name="content" class="form-control" required  style="background-color:white; border : none;"></textarea></td>
					</tr>
					<tr>
