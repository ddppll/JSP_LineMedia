...
public class ApplyContentCommand implements ApplyBoardInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ApplyVO preVO = dao.preNextSearch("pre", idx, mid);		//이전글 처리
		ApplyVO nextVO = dao.preNextSearch("next", idx, mid);	//다음글 처리
