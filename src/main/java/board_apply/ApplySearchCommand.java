...
public class ApplySearchCommand implements ApplyBoardInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totRecCnt = dao.totRecCnt(search, searchString, mid);
		...
		int lastBlock = (totPage % blockSize)==0 ? ((totPage / blockSize) - 1) : (totPage / blockSize);
	  	...
	  	List<ApplyVO> vos =  dao.getApplySearch(search, searchString, startIndexNo, pageSize, mid); //전체자료검색
